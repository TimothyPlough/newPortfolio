  ...
  return (
    <SelfSummaryContainer>
      <TopRow>
        ...
        <Row>
          <LogoButton source="/images/logos/github.png" size={75} margin={12} linkTo="https://github.com/TimothyPlough" />
          <LogoButton source="/images/logos/linkedIn.png" size={75} margin={12} linkTo="https://www.linkedin.com/in/timothyplough/" />
        </Row>
      </TopRow>
